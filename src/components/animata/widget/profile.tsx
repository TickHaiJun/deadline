...
export default function Profile() {
  return (
    <div className="group flex h-52 w-52 flex-col items-center justify-center rounded-3xl bg-[#f39595] p-4 shadow-sm transition-all duration-300 ">
      <img
        alt=""
      ...
      <div className="mt-2 flex flex-col items-center justify-center">
        <h3 className="font-sans font-semibold text-foreground">程序员海军</h3>
        <p className="text-sm font-light text-muted-foreground">Wechat： daxin261</p>
      </div>
